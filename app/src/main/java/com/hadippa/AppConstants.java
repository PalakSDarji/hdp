...
public class AppConstants {
    ...
    public static final String ACTIVITY_DELETE = "/post/delete";
    ...
    public static final String SEARCH_PEOPLE = "/search/people/city";
    ...
    public static final int ACTIVITY_MOVIE = 23;
