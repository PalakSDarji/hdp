...
public class CrystalRangeSeekbar extends View {
    ...
    public CrystalRangeSeekbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try{
            ...
            barHeight               = 15;//getBarHeight(array);

            Log.v("RS","minValue :"+minValue+", maxValue :"+maxValue+", barHighlightColor: "+barHighlightColor);
        }
        finally {
            array.recycle();
        }
    ...
    public void apply(){
       ...
       // barHeight = (thumbHeight * 0.5f) * 0.4f;
    ...
    protected float getBarHeight(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.CrystalRangeSeekbar_bar_height, 50f);
